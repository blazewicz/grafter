...
import { buildDiffTree } from '../../../src/renderer/diff/diff-tree';
import { DiffFileTree } from '../../../src/renderer/diff/DiffFileTree';
...
function renderDiffFileTree({
  expanded = new Set(['src', 'src/renderer', 'src/renderer/diff']),
  forceExpanded = false,
  activeFileId,
  contextFileId,
  onToggle = () => undefined,
